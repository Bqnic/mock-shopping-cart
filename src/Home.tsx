...
export default function Home({ featured, closeCart }: HomeProps) {
  ...
  return (
    <div className="flex flex-col">
      <div className="text-xl mt-10 flex w-full h-full items-center justify-around p-12 mb-10">
        <div className="flex flex-col gap-10">
          ...
          <div>
            ...
            <p>
              To be fair this text is creative, but in my defense, here is a
              random picture:
            </p>
          </div>
        </div>
      ...
      <p className="text-3xl mb-5">Featured items:</p>
